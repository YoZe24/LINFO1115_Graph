...
public class GraphHandler {
    ...
    public static HashMap<Designer,HashSet<Follow>> createPartialGraph(String followers_file){
        HashMap<Designer,HashSet<Follow>> graph = new HashMap<>();
        try {
            ...
            while(line != null){
                ...
                Follow follow = new Follow(follower,followed,Integer.parseInt(line[2]));
    ...
    public static HashMap<Designer, HashSet<Follow>> createCompleteGraph(String followers_file, String designers_file, String shots_file){
        HashMap<Designer, HashSet<Follow>> graph = new HashMap<>();
    ...
    // Create a graph without all information, only with followers.csv
    public static HashMap<Designer,HashSet<Follow>> createUndirectedGraph(String followers_file){
        HashMap<Designer,HashSet<Follow>> graph = new HashMap<>();
        int i = 0;
        try {
            CSVReader reader = new CSVReader(new FileReader(followers_file));
            ...
            while(line != null){
                ...
                Follow follow1 = new Follow(follower, followed,Integer.parseInt(line[2]));
                Follow follow2 = new Follow(followed, follower,Integer.parseInt(line[2]));
    ...
    public static HashMap<Designer, HashSet<Follow>> createMockDirectedGraph(){
        HashMap<Designer, HashSet<Follow>> graph = new HashMap<>();
        for (int i = 1; i <= 10; i++) {
            ...
            switch (i){
                case 1:
                    graph.get(designer).add(new Follow(designer,new Designer(2),1));
                    graph.get(designer).add(new Follow(designer,new Designer(5),2));
                    break;
                case 3:
                    graph.get(designer).add(new Follow(designer,new Designer(1),3));
                    break;
                case 4:
                    graph.get(designer).add(new Follow(designer,new Designer(5),4));
                    break;
                case 5:
                    graph.get(designer).add(new Follow(designer,new Designer(3),2));
                    graph.get(designer).add(new Follow(designer,new Designer(8),1));
                    break;
                case 6:
                    graph.get(designer).add(new Follow(designer,new Designer(10),3));
                    break;
                case 7:
                    graph.get(designer).add(new Follow(designer,new Designer(5),5));
                    graph.get(designer).add(new Follow(designer,new Designer(6),1));
                    break;
                case 8:
                    graph.get(designer).add(new Follow(designer,new Designer(6),1));
                    break;
    ...
    public static HashMap<Designer, HashSet<Follow>> createMockUndirectedGraph(){
